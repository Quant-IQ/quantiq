...
import { getLiveSignals } from "@/lib/api";
...
export default function LivePage() {
  const { data, error, loading, refetch } = usePolling(getLiveSignals, POLL_INTERVAL_MS);
  ...
  return (
    <div className="py-8 space-y-6">
      ...
      {trades.length === 0 ? (
        <EmptyState icon="bolt" message="Coming Soon: Awaiting scripting team to enable live bot execution logger." />
      ) : (
